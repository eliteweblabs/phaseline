...
export const googleAnalyticsMeasurementID = import.meta.env.PUBLIC_GA_TRACKING_ID || 'G-VCLC828W89' // Replace with your Google Analytics Measurement ID (e.g. "G-XXXXXXXXXX")
